...
const BookAppointment = () => {
  ...
  const getIndex = () => {
    return _.findIndex(hospitals, function(o) { return o._id === watch('hospital'); })
  }
        ...
        <Col xs="12" md="12">
          <Card>
            <Row className="no-gutters">
              ...
              <Col xs="12" md="7">
                <FrameMap
                  name={watch('hospital') && hospitals && hospitals.length > 0 && hospitals[getIndex()].name}
                  lat={watch('hospital') && hospitals  && hospitals.length > 0 && hospitals[getIndex()].latitude}
                />
              </Col>
            </Row>
          </Card>
